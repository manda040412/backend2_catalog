...
<body>
  <div class="wrapper">
    ...
    <div class="body">
      ...
      <?php if($status === 'approved'): ?>
      <div class="cta-wrap">
        <a href="<?php echo e(config('app.url')); ?>" class="cta-btn">Masuk ke TRAD Catalog →</a>
      </div>
      <?php endif; ?>
...
</html><?php /**PATH D:\Manda\VSCode\Catalog\catalog-backend\resources\views/emails/approval-notification.blade.php ENDPATH**/ ?>